...
""",
    ...
    def test_public_blog_host_includes_adsense_and_skips_lab_hosts(self):
        ...
        self.assertIn("G-CDGKSP6YER", public_body)
        self.assertIn("gtag/js?id=G-CDGKSP6YER", public_body)
        self.assertNotIn("G-SLDFDNQC98", public_body)
        self.assertIn("GTM-KXQJ9B42", blackknight_body)
        self.assertNotIn("GTM-TRK7JDZ", blackknight_body)
        self.assertIn("G-SLDFDNQC98", blackknight_body)
        self.assertIn("gtag/js?id=G-SLDFDNQC98", blackknight_body)
        self.assertNotIn("G-CDGKSP6YER", blackknight_body)
        self.assertNotIn("adsbygoogle.js?client=", blackknight_body)
        self.assertNotIn("data-ad-slot=", blackknight_body)
        self.assertEqual(ui_app.ga_measurement_for_host("www.blackknightcontroller.com"), "G-SLDFDNQC98")
        self.assertEqual(ui_app.ga_measurement_for_host("linux-users.auzietek.com"), "G-CDGKSP6YER")
        self.assertEqual(ui_app.ga_measurement_for_host("auzietek.com"), "G-CDGKSP6YER")
        self.assertIn("GTM-TRK7JDZ", auzietek_body)
        self.assertIn("G-CDGKSP6YER", auzietek_body)
        self.assertIn("gtag/js?id=G-CDGKSP6YER", auzietek_body)
        self.assertNotIn("G-SLDFDNQC98", auzietek_body)
